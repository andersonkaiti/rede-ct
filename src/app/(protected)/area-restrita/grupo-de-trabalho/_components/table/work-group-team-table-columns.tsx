...
interface IWorkGroupTeamMemberUser {
  id: string
  name: string
...
interface IWorkGroupTeamMember {
  id: string
  role: string
...
export const workGroupTeamTableColumns: ColumnDef<IWorkGroupTeamMember>[] = [
  {
    id: 'name',
    header: 'Nome',
    cell: ({
