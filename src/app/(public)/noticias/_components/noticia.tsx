...
export function Noticia({
  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      >
        ...
        <div className="flex h-fit flex-grow flex-col justify-between gap-4 py-2">
          ...
          <div className="space-y-2">
            <div className="line-clamp-3 text-justify text-muted-foreground text-sm leading-relaxed">
              {content}
            </div>
          </div>
      ...
      <footer className="flex w-full items-center justify-between gap-x-2 pt-2">
