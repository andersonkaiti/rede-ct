      ...
      <div className="container mx-auto px-4">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="flex flex-col justify-center gap-4 sm:flex-row">
            <button
              className="rounded-md bg-gray-900 px-8 py-3 font-medium text-white transition-colors hover:bg-gray-800"
              type="button"
            >
              Entre em Contato
            </button>
            <button
              className="rounded-md border border-gray-300 px-8 py-3 font-medium text-gray-700 transition-colors hover:bg-gray-50"
              type="button"
            >
              Saiba Mais
            </button>
