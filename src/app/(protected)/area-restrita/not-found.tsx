...
export default function NotFound() {
  return (
    <main className="flex min-h-[calc(100vh-4rem)] items-center justify-center bg-linear-to-b from-primary/20 via-background to-background p-4 py-10 lg:p-25 dark:from-destructive/10">
      <div className="mx-auto max-w-(--breakpoint-sm) space-y-6 text-center">
        ...
        <div className="mt-8 flex items-center justify-center gap-x-6">
          <Button asChild variant="ghost">
            <Link href="/area-restrita">Voltar para a página inicial</Link>
          </Button>
        </div>
      </div>
    </main>
