...
import type { IInMemoriam } from './in-memoriam-researchers'
...
export async function getInMemoriamTraditionalLeaders(): Promise<
  IInMemoriam[]
> {
  return await new Promise((resolve) => resolve(inMemoriamTraditionalLeaders))
}
