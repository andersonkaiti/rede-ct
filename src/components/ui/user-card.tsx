...
function UserCardImage({ alt, src, ...rest }: ImageProps) {
  return (
    <Avatar className="ring-primary/20 relative size-30 rounded-full shadow-2xl ring-4">
      <div className="from-primary absolute inset-0 scale-110 rounded-full bg-gradient-to-r to-red-600 opacity-20 blur-lg"></div>
      <AvatarImage
        src={src as string}
        alt={alt}
