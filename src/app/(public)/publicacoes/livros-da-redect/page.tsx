    ...
    <div className="mx-auto flex max-w-7xl flex-col justify-center gap-12.5 p-5 py-10 lg:p-25">
      ...
      <div className="mx-auto grid max-w-5xl items-center gap-8 md:grid-cols-2">
        <div className="space-y-4 text-left">
          ...
          <p className="text-3xl font-bold">Série na Editora Fi</p>
          ...
          <div className="bg-primary/10 text-primary border-primary/10 rounded-md border p-4 text-sm italic">
      ...
      <main className="space-y-20">
        ...
        <section className="from-primary space-y-6 rounded-md bg-gradient-to-br to-red-700 p-6 text-center text-white md:p-10">
