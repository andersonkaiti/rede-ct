...
import { EditIcon, Ellipsis, FileText } from 'lucide-react'
    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent>
        <DropdownMenuItem asChild className="p-0">
          <Link href={`/area-restrita/institucional/reunioes/editar/${id}`}>
            <Button
        ...
        <DropdownMenuItem asChild className="p-0">
          <Link href={`/area-restrita/institucional/reunioes/ata/${id}`}>
            <Button
              className="flex w-full justify-between text-xs"
              variant="ghost"
            >
