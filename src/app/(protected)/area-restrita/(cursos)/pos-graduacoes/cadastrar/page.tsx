...
import { useCreatePostGraduateProgram } from './use-create-post-graduate-program.hook'
...
export default function CadastrarPosGraduacao() {
  ...
  return (
    <PageContainer>
      <PageHeaderContent>
        <PageTitle>Cadastrar Programa de Pós-Graduação</PageTitle>
        <PageDescription>
          Preencha os campos abaixo para cadastrar um novo programa de
          pós-graduação.
        </PageDescription>
      </PageHeaderContent>
