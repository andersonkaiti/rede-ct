...
export function Book({
  ...
  return (
    <div
      className={cn(
        'group perspective-distant inline-block w-fit cursor-pointer transition-all duration-300',
      )}
      style={
        {
          '--book-color': color,
    ...
    >
      <div
        className={cn(
          'transform-3d relative w-fit min-w-[calc(var(--book-width))] rotate-0 transition-all duration-700 ease-out contain-inline-size',
      ...
      >
        ...
        >
          ...
          {spineText && (
            <div
              className="-translate-y-1/2 -rotate-90 absolute top-1/2 left-0 z-10 whitespace-nowrap px-2 font-semibold text-xs"
            ...
            >
              ...
              {(title || author) && (
                <div className="p-4 text-center">
                  {title && (
                    <h3
                      className={cn('mb-2 font-bold text-lg')}
