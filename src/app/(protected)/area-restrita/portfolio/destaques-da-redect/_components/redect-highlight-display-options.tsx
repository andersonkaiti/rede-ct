...
import { redectHighlightTableColumns } from './table/redect-highlight-table-columns'

export function RedeCTHighlightDisplayOptions() {
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end">
        ...
        {redectHighlightTableColumns.map((col) => {
